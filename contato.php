...
<body>
	...
	$nome_cont = $_POST['txt_nome'];
	$email_cont = $_POST['txt_email'];
	$assunto_cont = $_POST['txt_assunto'];
		$msg_cont = $_POST['txt_mensagem'];
	...
	$Email->AddAddress("supadmrealjp@gmail.com");
	...
	if(!$Email->Send()) {
	 echo "<script>alert('Não foi possivel enviar, tente novamente');window.location='/Geriatria/contato.html';</script>";
	 //echo "Erro: " . $mail->ErrorInfo;
	}
	else {
		echo "<script>alert('Enviado com Sucesso, em breve responderemos.');window.location='/Geriatria/index.html';</script>";
	}
